...
var calc = require(path.join(__dirname, "..", "..", "power", "assets", "calc.js"));
var defaults = require(path.join(__dirname, "..", "..", "power", "assets", "defaults.js"));
var storage = require(path.join(__dirname, "..", "..", "power", "assets", "storage.js"));
...
test("isWave3FocusHash matches #wave3 / #appliance-wave3 only", function () {
  ...
  assert.strictEqual(calc.isWave3FocusHash("wave3"), true);
  assert.strictEqual(calc.isWave3FocusHash("https://motorhometools.co.uk/power/?wave3=1#wave3"), true);
